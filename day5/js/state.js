/* ==========================================================================
   Majal Day 5 — core engine: DOM helpers, widget registry, brand chrome,
   Reveal boot.  (Shared with Day 1; day flag differs.)
   ========================================================================== */
...
MAJAL.mountChrome = function () {
  ...
  var d = MAJAL.el("div", { class: "dayflag", text: "DAY 5 · THE DEFENDER'S CHAIR" });
