/* ==========================================================================
   Majal Day 3 — core engine: DOM helpers, widget registry, brand chrome,
   Reveal boot.  (Shared with Day 1/2; day flag differs.)
   ========================================================================== */
...
MAJAL.mountChrome = function () {
  ...
  var d = MAJAL.el("div", { class: "dayflag", text: "DAY 3 · MOVING THROUGH" });
